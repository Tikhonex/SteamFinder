<?php
$api_key = "{APIKEY}"; // Your Steam WebAPI-Key found at http://steamcommunity.com/dev/apikey
$domainname = "{DOMAIN}"; // The main URL of your website displayed in the login page
